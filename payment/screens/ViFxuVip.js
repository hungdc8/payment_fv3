...
export default class ViFxuVip extends Component<{}> {
    render() {
        return (
            <Container>
                    ...
                    <Grid>
                        <Col style={{ padding: 10, backgroundColor: 'white', borderColor: '#3399FF', borderWidth: 1 }}>
                            <Card>
                                <CardItem >
                                    <Body >
                                        <Text style={{ color: 'black', fontWeight: 'bold' }}>Bạn đang mua gói VIP 365 ngày bằng Ví Fxu</Text>
                                    </Body>
                                </CardItem>
                            </Card>
                            <Card>
                            ...
                            <Form>
                                ...
                                <Grid>
                                    ...
                                    <Col style={{ flex: 1 }}>
                                        <Button transparent style={{ marginTop: 10, borderColor: '#CC3227', borderWidth: 2 }}>
